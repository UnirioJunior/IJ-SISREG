                ...
                if (response.data.token !== 'Acesso negado') {
                    ...
                    try {
                        ...
                        if (userId) {
                            ...
                            usuarioService.buscarPordId(userId)
                                .then((userResponse) => {
                                    const user = userResponse.data;
                                    if (user) {
                                        localStorage.setItem('USER_DATA', JSON.stringify(user));
                                        console.log('Lista de acessos:', user.acessos);
                                    }
                                })
                                .catch((error) => {
                ...
                >
                    <div className="w-full surface-card py-8 px-5 sm:px-8" style={{ borderRadius: '53px' }}>
                        ...
                        <div>
                            ...
                            <Password inputId="senha" value={senha} onChange={(e) => setSenha(e.target.value)} placeholder="Password" onKeyPress={handleKeyPress} toggleMask className="w-full mb-5" inputClassName="w-full p-3 md:w-30rem"></Password>
